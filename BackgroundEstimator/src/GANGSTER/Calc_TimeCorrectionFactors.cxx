...
void GANGSTER::Calc_TimeCorrectionFactors(vector<string> GRB_folders, vector <double> METs, vector <double> GRB_L, vector <double> GRB_B, string Dataclass, double MinE, double MaxE, int NBins, const int Max_iE_For_Correction){
