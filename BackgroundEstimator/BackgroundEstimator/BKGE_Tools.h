...
const float GBMDet_Theta_Azimuth[14][2]={
 ...
 , {90.0, 180.00}};
    ...
    */
    ...
    int Make_Burst_Plots(string DataClass, string FT1_FILE, string GRB_DIR, float FT1ZenithTheta_Cut, double RA_BURST, double DEC_BURST, double GRB_t0, double Burst_Dur, TH1F* hROI_Max, short int verbosity=1, TH1F * hROI_Min=0, TH1F * hCtsvsEnergy_copy=0, bool Save_Earth_Coo_Map=false);
