...
int speclog(double dummy, int nspec, int sspec, int sloge, const double spec[], 
			double loge[], int stat[])
{
   int status = 0;
...
int logspec(double dummy, int nloge, int sloge, int sspec, const double loge[],
			double spec[], int stat[])
{
...
int freqwave(double dummy, int nfreq, int sfreq, int swave, const double freq[],
			 double wave[], int stat[])
{
   int status = 0;
...
int wavefreq(double dummy, int nwave, int swave, int sfreq, const double wave[],
			 double freq[], int stat[])
{
   int status = 0;
...
int freqawav(double dummy, int nfreq, int sfreq, int sawav, const double freq[],
			 double awav[], int stat[])
{
   int status;
...
int awavfreq(double dummy, int nawav, int sawav, int sfreq, const double awav[],
			 double freq[], int stat[])
{
   int status;
...
int freqvelo(double restfrq, int nfreq, int sfreq, int svelo, const double freq[],
			 double velo[], int stat[])
{
   double r, s;
   register int ifreq, *statp;
   register const double *freqp;
...
int velofreq(double restfrq, int nvelo, int svelo, int sfreq, const double velo[],
			 double freq[], int stat[])
{
   int status = 0;
   double s;
...
int waveawav(double dummy, int nwave, int swave, int sawav, const double wave[],
			 double awav[], int stat[])
{
   int status = 0;
   double n, s;
...
int awavwave(double dummy, int nawav, int sawav, int swave, const double awav[],
			 double wave[], int stat[])
{
   int status = 0;
   double n, s;
...
int wavevelo(double restwav, int nwave, int swave, int svelo, const double wave[],
			 double velo[], int stat[])
{
   double r, s;
   register int iwave, *statp;
...
int velowave(double restwav, int nvelo, int svelo, int swave, const double velo[],
			 double wave[], int stat[])
{
   int status = 0;
   double s;
...
int awavvelo(double dummy, int nawav, int sawav, int svelo, const double awav[],
			 double velo[], int stat[])
{
   int status;
...
int veloawav(double dummy, int nvelo, int svelo, int sawav, const double velo[],
			 double awav[], int stat[])
{
   int status;
...
int freqafrq(double dummy, int nfreq, int sfreq, int safrq, const double freq[],
			 double afrq[], int stat[])
{
   register int ifreq, *statp;
   register const double *freqp;
...
int afrqfreq(double dummy, int nafrq, int safrq, int sfreq, const double afrq[],
			 double freq[], int stat[])
{
...
int freqener(double dummy, int nfreq, int sfreq, int sener, const double freq[],
			 double ener[], int stat[])
{
   register int ifreq, *statp;
   register const double *freqp;
...
int enerfreq(double dummy, int nener, int sener, int sfreq, const double ener[],
			 double freq[], int stat[])
{
...
int freqwavn(double dummy, int nfreq, int sfreq, int swavn, const double freq[],
			 double wavn[], int stat[])
{
   register int ifreq, *statp;
   register const double *freqp;
...
int wavnfreq(double dummy, int nwavn, int swavn, int sfreq, const double wavn[], 
			 double freq[], int stat[])
{
...
int freqvrad(double restfrq, int nfreq, int sfreq, int svrad, const double freq[],
			 double vrad[], int stat[])
{
   double r;
   register int ifreq, *statp;
   register const double *freqp;
...
int vradfreq(double restfrq, int nvrad, int svrad, int sfreq, const double vrad[],
			 double freq[], int stat[])
{
   double r;
...
int wavevopt(double restwav, int nwave, int swave, int svopt, const double wave[],
			 double vopt[], int stat[])
{
   double r;
   register int iwave, *statp;
   register const double *wavep;
...
int voptwave(double restwav, int nvopt, int svopt, int swave, const double vopt[],
			 double wave[], int stat[])
{
   double r;
...
int wavezopt(double restwav, int nwave, int swave, int szopt, const double wave[],
			 double zopt[], int stat[])
{
   double r;
   register int iwave, *statp;
   register const double *wavep;
...
int zoptwave(double restwav, int nzopt, int szopt, int swave, const double zopt[], 
			 double wave[], int stat[])
{
...
int velobeta(double dummy, int nvelo, int svelo, int sbeta, const double velo[], 
			 double beta[], int stat[])
{
   register int ivelo, *statp;
   register const double *velop;
...
int betavelo(double dummy, int nbeta, int sbeta, int svelo, const double beta[],
			 double velo[], int stat[])
{
