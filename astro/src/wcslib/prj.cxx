...
int prjx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   /* Initialize. */
   if (prj == 0) return 1;
   if (prj->flag == 0) {
...
int prjs2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   /* Initialize. */
   if (prj == 0) return 1;
   if (prj->flag == 0) {
...
int offset(struct prjprm *prj, const double phi0, const double theta0)
{
   int    stat;
...
int azpx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
...
int azps2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
...
int szpx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
...
int szps2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
...
int tanx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[], 
		   const double y[], double phi[], double theta[], int stat[])
{
...
int tans2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
...
int stgx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
   double r, xj, yj, yj2;
...
int stgs2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
   double cosphi, r, s, sinphi;
...
int sinx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[], 
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
   const double tol = 1.0e-13;
...
int sins2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
...
int arcx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
   double r, xj, yj, yj2;
...
int arcs2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
...
int zpnx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
...
int zpns2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
...
int zeax2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double  phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
...
int zeas2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
   double cosphi, r, sinphi;
...
int airx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
...
int airs2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
...
int cypx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
   double eta, s, t;
...
int cyps2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
   double eta, xi;
...
int ceax2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
   double s;
...
int ceas2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
   double eta, xi;
...
int carx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
   double s, t;
...
int cars2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
   double eta, xi;
...
int merx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
   double s, t;
...
int mers2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
   double eta, xi;
...
int sflx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
   double s, t, yj;
...
int sfls2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
   double eta, xi;
...
int parx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
   double r, s, t, xj;
...
int pars2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
   double eta, s, xi;
...
int molx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[], 
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
...
int mols2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
...
int aitx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
...
int aits2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
...
int copx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
...
int cops2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
...
int coex2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
...
int coes2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double  phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
...
int codx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
   double alpha, dy, dy2, r, xj;
...
int cods2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
   double alpha, cosalpha, r, sinalpha, y0;
...
int coox2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
...
int coos2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff, status;
   double alpha, cosalpha, r, sinalpha, y0;
...
int bonx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
...
int bons2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
   double alpha, r, s, y0;
...
int pcox2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff;
...
int pcos2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int mphi, mtheta, rowlen, rowoff;
...
int tscx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
   int mx, my, rowlen, rowoff, status;
   double l, m, n, xf, yf;
...
int tscs2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
...
int cscx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
...
int cscs2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int face, mphi, mtheta, rowlen, rowoff, status;
...
int qscx2s(struct prjprm *prj, int nx, int ny, int sxy, int spt, const double x[],
		   const double y[], double phi[], double theta[], int stat[])
{
...
int qscs2x(struct prjprm *prj, int nphi, int ntheta, int spt, int sxy, const double phi[],
		   const double theta[], double x[], double y[], int stat[])
{
   int face, mphi, mtheta, rowlen, rowoff, status;
